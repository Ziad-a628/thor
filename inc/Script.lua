...
local inline = {{{text="-قنآهہ‏‏ آلسـورس اضـغـط هـنـآ ",url="https://t.me/SourceThor"}}}
send_key(msg.sender_user_id_,'   [قناة سورس : ثور](https://t.me/SourceThor)' ,nil,inline,msg.id_)
return false
end
...
[➺ 𝐄𝐋𝐌𝐀𝐒𝐑𝐘 𝟏](t.me/ElMasry_776)

[➺ ⁦𝐙 𝐄 𝐔 𝐒⚡ 𝟐](t.me/ZU_XU)

[➺ 𝐌𝐎𝐀𝐓𝐀𝐙 ](t.me/VV_0M)

[➺ 𝐂𝐇𝐀𝐍𝐍𝐄𝐋𝐒𝐎𝐔𝐑𝐂𝐄](t.me/SourceThor)
________________𝖇𝖞 𝖟𝖊𝖚𝖘 ⚡____________
]]
end
...
elseif Text== "زياد" or Text== "زوز" then return  sendMsg(msg.chat_id_,msg.id_,"[مطور كل السورسات 🇪🇬](https://t.me/@ZU_XU)")
elseif Text== "مصري"  then return sendMsg(msg.chat_id_,msg.id_,"[مطور سورس ثور ↯](https://t.me/ElMasry_776)")
elseif Text== "ميزو" or Text== "معتز"  then return sendMsg(msg.chat_id_,msg.id_,"[↯ مطور سورس ميلان ↯](https://t.me/VV_0M)")
...
elseif Text:match(Bot_Name.."كيفك") then 
  ...
  elseif Text== "كسمك"  then return sendMsg(msg.chat_id_,msg.id_,"عيب والله 🔹.")
 ...
 elseif Text== "مساعدة"  then return sendMsg(msg.chat_id_,msg.id_,"لعرض قائمة المساعدة اكتب الاوامر 🌚❤️")
  ...
  if data.username_ then USERNAME = '@'..data.username_ else USERNAME = FlterName(data.first_name_..' '..(data.last_name_ or "")) end
  local USERCAR = utf8.len(USERNAME)
  SendMention(msg.chat_id_,data.id_,msg.id_,"\n\n _ 𝚄𝚂𝙴𝚁 ⇈ "..USERNAME..".   _ 𝚈𝙾𝚄𝚁 𝙸𝙳 ↜ "..data.id_.." ",37,USERCAR)  
  return false
  end)
